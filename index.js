...
const serviceAccount =
  env === "development"
    ? require("./secrets/firebase-adminsdk.json")
    : require("/secrets/avd/anand-vrindavan-dham-firebase-adminsdk.json");

const config =
  env === "development"
    ? require("./secrets/config")
    : require("/secrets/avd/config");
...
var whitelist = [
  ...
  "http://localhost:8100",
  "http://localhost:8200",
  "http://192.168.31.249:8100",
  "http://169.254.190.158:8100",
  "https://www.anandvrindavan.com",
  "https://anandvrindavan.com",
  "https://admin.anandvrindavan.com",
  "http://localhost:3000",
];
var corsOptions = {
